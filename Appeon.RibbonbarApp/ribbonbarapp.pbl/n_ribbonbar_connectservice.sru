//objectcomments Generated Database Connection Service
forward
global type n_ribbonbar_connectservice from nonvisualobject
end type
end forward

global type n_ribbonbar_connectservice from nonvisualobject
end type
global n_ribbonbar_connectservice n_ribbonbar_connectservice
...
Choose Case is_connectfrom
	...
	Case IS_USE_INIFILE						/*  Populate Database Connection from INI file  */
		...
		as_dbparm		= ProfileString ( ls_inifile, "Database", "DBParm", "ConnectString='DSN=PB Demo DB V2022R3;UID=dba;PWD=sql'")
...
on n_ribbonbar_connectservice.create
call super::create
TriggerEvent( this, "constructor" )
end on

on n_ribbonbar_connectservice.destroy

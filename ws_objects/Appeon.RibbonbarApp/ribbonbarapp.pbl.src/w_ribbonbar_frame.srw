$PBExportHeader$w_ribbonbar_frame.srw
$PBExportComments$Generated MDI Frame
forward
global type w_ribbonbar_frame from window
end type
type mdi_1 from mdiclient within w_ribbonbar_frame
end type
type mdirbb_1 from ribbonbar within w_ribbonbar_frame
end type
type mditbb_1 from tabbedbar within w_ribbonbar_frame
end type
type rbb_main from ribbonbar within w_ribbonbar_frame
end type
end forward
...
global w_ribbonbar_frame w_ribbonbar_frame
